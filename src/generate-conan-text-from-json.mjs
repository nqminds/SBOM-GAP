...
function sanitiseDependency(dep) {
  if (!dep) return null;
 ...
 * then
 * generateConanFile(edgesec) // make sure edgesec_dependencies exists in vulnerability-reports/cssDependencies/
 *
